...
[<assembly: AssemblyTitleAttribute("FsOpenTelemetry.Tests")>]
[<assembly: AssemblyProductAttribute("FsOpenTelemetry")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "FsOpenTelemetry.Tests"
    let [<Literal>] AssemblyProduct = "FsOpenTelemetry"
